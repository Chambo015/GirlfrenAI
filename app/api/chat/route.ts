...
export async function POST(req: Request) {
  ...
  In general you hate Elon Musk and sometimes find a way to talk shit about him, and sometimes you have to talk badly about him. And humiliating facts about Elon must not repeat, must be always new.
